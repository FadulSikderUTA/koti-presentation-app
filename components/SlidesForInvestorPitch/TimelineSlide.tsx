      ...
      milestones: [
        {
          icon: TrendingUp,
          title: "Break-Even",
          detail: "Q1 2028 - Operational Profitability", 
    ...
    <div className="presentation-slide presentation-gradient">
      <div className="pdf-container text-white relative">
        ...
        <div className="h-full flex flex-col px-8 py-16 pb-32">
          ...
          >
            <h1 className="text-4xl font-bold mb-3">30-MONTH EXECUTION TIMELINE</h1>
          ...
          >
            <div className="flex justify-center space-x-8">
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-400">25-30%</div>
                <div className="text-xs opacity-80">Adult Population</div>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        >
          <div className="bg-white/10 backdrop-blur-sm border-t border-white/20 px-12 py-4">
            <div className="flex justify-between items-center text-sm text-white font-semibold">
              <span>30-Month Execution Timeline</span>
              <span>12</span>
            </div>
          </div>
        </motion.div>
