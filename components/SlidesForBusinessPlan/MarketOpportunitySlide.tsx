...
export default function MarketOpportunitySlide({ 
  ...
  const marketSizes = [
    { label: "Total Addressable Market", sublabel: "All formal lenders + MFIs", value: "50+ Banks/NBFIs + 731 MFIs" },
    { label: "Serviceable Available Market", sublabel: "5 banks in first 18 months, then scale up", value: "Initial: 5 Banks + 10 MFIs" }
  ];
  ...
  return (
    <div className="presentation-slide presentation-gradient">
      <div className="pdf-container text-white relative">
        ...
        {/* Main Content */}
        <div className="h-full flex flex-col px-6 py-16 pb-44">
          {/* Title Section */}
          <motion.div
        ...
        <motion.div 
          className="grid grid-cols-5 gap-3 mb-4 -mx-2"
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        <motion.div 
          className="flex-1 flex items-stretch justify-between gap-4 mb-4 -mx-2"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
          ...
          >
            ...
            <div className="space-y-2 text-xs flex-1">
              ...
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-2">
                <div className="font-bold text-gray-800 mb-1">Financial Inclusion</div>
                <div className="text-gray-600 mb-1">Expanding formal credit access</div>
